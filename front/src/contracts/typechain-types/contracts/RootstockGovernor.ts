...
export interface RootstockGovernorInterface extends utils.Interface {
  functions: {
    ...
    "createProposal(address[],uint256[],bytes[],string,uint8)": FunctionFragment;
    ...
    "proposalIds(bytes32)": FunctionFragment;
...
export interface RootstockGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RootstockGovernorInterface;
  ...
  functions: {
    ...
    createProposal(
      ...
      countingType: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
